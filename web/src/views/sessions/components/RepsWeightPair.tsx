...
export function RepsWeightPair({ reps, weight_kg, unit, onChangeReps, onChangeWeight }: Props) {
  return (
    <>
      <Input
        type="number"
      ...
      <Input
        ...
        onChange={(e) => onChangeWeight(displayStringToWeightKg(e.target.value, unit))}
      />
    </>
  );
}
