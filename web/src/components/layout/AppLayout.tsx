...
import { CalendarDays, LayoutTemplate, BarChart2, ShieldCheck, LogOut } from 'lucide-react'
      ...
      <header className="border-b bg-card sticky top-0 z-40">
        <div className="px-4 h-14 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button variant="ghost" size="icon" onClick={logout} className="md:hidden text-destructive hover:text-destructive hover:bg-destructive/10">
      ...
      <nav className="md:hidden fixed bottom-0 left-0 right-0 z-40 border-t bg-card">
        <div className="flex items-center justify-around h-16">
          ...
          {role === 'admin' && (
            ...
            >
              <ShieldCheck className={cn('size-5', pathname.startsWith('/admin') && 'text-primary')} />
